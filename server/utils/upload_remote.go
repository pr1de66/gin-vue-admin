...
func UploadRemote(file *multipart.FileHeader) (err error, path string, key string) {
	...
	if err != nil {
		global.LOG.Error("upload file fail:", zap.Any("err", err))
		return err, "", ""
	}
	return err, global.CONFIG.Qiniu.ImgPath + "/" + ret.Key, ret.Key
}
...
func DeleteFile(key string) error {
	...
	err := bucketManager.Delete(global.CONFIG.Qiniu.Bucket, key)
	if err != nil {
		fmt.Println(err)
		return err
	}
